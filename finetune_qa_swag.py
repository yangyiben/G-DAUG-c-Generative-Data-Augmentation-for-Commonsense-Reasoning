...
from modeling import GenerativeGPT2QASwag

import torch.nn.functional as F

from transformers import AdamW, WarmupLinearSchedule, WarmupConstantSchedule

from swag_data_utils import (
    convert_examples_to_features_gpt2, processors)
...
MODEL_CLASSES = {
    'gpt2': (GPT2Config, GenerativeGPT2QASwag, GPT2Tokenizer),
}
...
def evaluate(args,
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
                ...
                if generation:
                    ...
                    for i in range(inputs['input_ids'].size(0)):
                        ...
                        sentence = model.generate(
                            ...
                            30,
                            label=inputs['input_ids'][i:i + 1, question_length:],
                            tmp=0.5)
                        #print(sentence)
        ...
        if mc:
            ...
            np.save(os.path.join(args.data_dir, "preds.npy"), preds)
