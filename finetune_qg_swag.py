...
from modeling import GenerativeGPT2QGSwag

from transformers import AdamW, WarmupLinearSchedule, WarmupConstantSchedule

from swag_data_utils import (convert_examples_to_generative_features, processors)
...
MODEL_CLASSES = {
    'gpt2': (GPT2Config, GenerativeGPT2QGSwag, GPT2Tokenizer),
}
