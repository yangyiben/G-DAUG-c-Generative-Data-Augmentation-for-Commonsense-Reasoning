...
from modeling import GenerativeGPT2QG

from transformers import AdamW, WarmupLinearSchedule, WarmupConstantSchedule

from data_utils import (convert_examples_to_generative_features, processors)
...
MODEL_CLASSES = {
    'gpt2': (GPT2Config, GenerativeGPT2QG, GPT2Tokenizer),
}
